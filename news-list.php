                    ...
                    <div class="table-responsive">
                      ...
                      >
                        ...
                        <tbody>
                          ...
                          ?>
                          <tr>
                            <td><img style="height: 5rem; width: 7rem;" src="<?php echo $row['image_url'] ?>" /></td>
                            <td><?php echo $row['title'] ?></td>
                            <td><?php echo $row['location'] ?></td>
                            <!-- <td><?php echo $row['description'] ?></td> -->
                            <?php $formattedDate = date("j F Y", strtotime($row['date'])); ?>
                            <td><?php echo $formattedDate ?></td>
                            <td><?php echo $row['reporter_name'] ?></td>
                            <td>
                              <div class="form-button-action">
                                 <a
                                  href="news_comment.php?news_id=<?php echo $row['news_id']; ?>"
                                  data-toggle="tooltip"
                                  title=""
                                ...
                                <a
                                  href="update_news.php?news_id=<?php echo $row['news_id']; ?>"
                                  data-toggle="tooltip"
                                  title=""
                                  class="btn btn-link btn-primary btn-lg"
                                ...
                                <a
                                  href="./backend/db_delete_news.php?news_id=<?php echo $row['news_id']; ?>"
                                  data-toggle="tooltip"
